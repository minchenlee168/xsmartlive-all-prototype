...
type StatusTab = 'all' | 'unpaid' | 'to_ship' | 'to_receive' | 'to_complete' | 'cancelled'
...
// 商品列子 tab
// 商品列子 tab
type DetailTab = 'progress' | 'cancel' | 'return' | 'exchange' | 'inquiry' | 'address' | 'payment'
...
interface TimelineStep {
  key: 'unpaid' | 'to_ship' | 'shipped' | 'delivered' | 'completed'
  label: string
  icon: string
}
...
// Order mock — 每個商品可以拆成多個包裹（waybill）
...
interface OrderRecord {
  ...
  delivery: string
  invoice: string
  status: 'unpaid' | 'to_ship' | 'to_receive' | 'to_complete' | 'cancelled'
  detailTab: DetailTab
  expanded: boolean
  items: OrderItem[]
}
    ...
    items: [
      {
        ...
        qty: 2,
        packages: [
          { no: 'F2026020501', qty: 2, currentStep: 'unpaid', stepTimes: SAMPLE_TIMES },
        ],
      },
      {
        image: IMG_HAT,
        ...
        qty: 1,
        packages: [
          { no: 'F2026020502', qty: 1, currentStep: 'unpaid', stepTimes: SAMPLE_TIMES },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        qty: 3,
        packages: [
          { no: 'F2026020401', qty: 3, currentStep: 'to_ship', stepTimes: SAMPLE_TIMES },
        ],
      },
      {
        image: IMG_HAT,
        ...
        qty: 1,
        packages: [
          { no: 'F2026020402', qty: 1, currentStep: 'to_ship', stepTimes: SAMPLE_TIMES },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        qty: 2,
        packages: [
          { no: 'F2026020301', qty: 2, currentStep: 'shipped', stepTimes: SAMPLE_TIMES },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        qty: 1,
        packages: [
          { no: 'F2026020201', qty: 1, currentStep: 'delivered', stepTimes: SAMPLE_TIMES },
        ],
      },
    ],
  },
  // 5. 已完成（completed）
  {
    ...
    items: [
      ...
      },
      {
        ...
        qty: 1,
        packages: [
          { no: 'F2026012911', qty: 1, currentStep: 'completed', stepTimes: SAMPLE_TIMES },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        qty: 1,
        packages: [
          { no: 'F2026012001', qty: 1, currentStep: 'unpaid', stepTimes: SAMPLE_TIMES },
        ],
      },
    ],
  },
